...
_FRESH_LINES: dict[str, tuple[str, ...]] = {
    "happy": (
        ...
        "A current release chosen by fit, not by a stored number — its buoyant, sunlit energy is what lands it in a happy set.",
        "Fresh off Apple's charts rather than the measured library, picked for the kind of bright, easy lift this mood is built on.",
        "A recent track surfaced live for its upbeat, feel-good character rather than pulled from the feature store.",
    ),
    "sad": (
        ...
        "A current release picked by feel alone — its slow, aching tone is what places it inside this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the muted, reflective weight a sad set carries.",
        "A recent track surfaced live for its sombre, unhurried feel rather than a measured library reading.",
    ),
    "angry": (
        ...
        "A current release chosen by fit — its hard, driving aggression is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the kind of blunt force an angry set runs on.",
        "A recent track surfaced live for its heat and bite rather than pulled from the feature store.",
    ),
    "calm": (
        ...
        "A current release picked by feel alone — its smooth, spacious quiet is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the unbothered, restful tone a calm set wants.",
        "A recent track surfaced live for its gentle, drifting ease rather than a measured library reading.",
    ),
    "anxious": (
        ...
        "A current release chosen by fit — its jittery, wound-up texture is what lands it inside this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the nervous, restless edge an anxious set leans into.",
        "A recent track surfaced live for its uneasy, keyed-up feel rather than pulled from the feature store.",
    ),
    "energetic": (
        ...
        "A current release picked by feel alone — its relentless drive is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the high-octane pace an energetic set runs on.",
        "A recent track surfaced live for its speed and lift rather than a measured library reading.",
    ),
    "focused": (
        ...
        "A current release chosen by fit — its unbroken, level groove is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the kind of quiet consistency a focused set leans on.",
        "A recent track surfaced live for its smooth, heads-down flow rather than pulled from the feature store.",
    ),
    "nostalgic": (
        ...
        "A current release picked by feel alone — its warm, backward glance is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the fond, remembering tone a nostalgic set carries.",
        "A recent track surfaced live for its sepia-toned, memory-soaked feel rather than a measured library reading.",
    ),
    "romantic": (
        ...
        "A current release chosen by fit — its soft, affectionate warmth is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the tender closeness a romantic set is built on.",
        "A recent track surfaced live for its intimate, heart-forward feel rather than pulled from the feature store.",
    ),
    "melancholic": (
        ...
        "A current release picked by feel alone — its heavy, pensive tone is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the sombre, inward weight a melancholic set leans into.",
        "A recent track surfaced live for its brooding, downcast feel rather than a measured library reading.",
    ),
    "confident": (
        ...
        "A current release chosen by fit — its bold, chest-out energy is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the assured strut a confident set runs on.",
        "A recent track surfaced live for its cocky, self-possessed feel rather than pulled from the feature store.",
    ),
    "hopeful": (
        ...
        "A current release picked by feel alone — its warm, upward pull is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the gently optimistic tone a hopeful set carries.",
        "A recent track surfaced live for its bright, looking-up feel rather than a measured library reading.",
    ),
    "frustrated": (
        ...
        "A current release chosen by fit — its clenched, simmering tension is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the gritted, held-back charge a frustrated set leans into.",
        "A recent track surfaced live for its tight, agitated feel rather than pulled from the feature store.",
    ),
    "lonely": (
        ...
        "A current release picked by feel alone — its hollow, one-person quiet is what places it in this mood.",
        "Fresh off Apple's charts rather than the feature store, chosen for the empty-room ache a lonely set carries.",
        "A recent track surfaced live for its bare, solitary feel rather than a measured library reading.",
    ),
    "dreamy": (
        ...
        "A current release chosen by fit — its blurred, floating haze is what lands it in this mood.",
        "Fresh off Apple's charts rather than the stored library, picked for the soft-focus drift a dreamy set is built on.",
        "A recent track surfaced live for its hazy, half-asleep feel rather than pulled from the feature store.",
    ),
}
